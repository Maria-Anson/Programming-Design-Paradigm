...
/**
 * ObservableBurrito is a better version of burrito which handles the setting of mutable variables.
 */
public interface ObservableBurrito {
   ...
   * @return the portion of this topping on this burrito, or null if the given topping is not on
   *         this burrito
   */
   ...
   * @return the portion of this protein on this burrito, or null if the given protein is not on
   *         this pizza
   */
